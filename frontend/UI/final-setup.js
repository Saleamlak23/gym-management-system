...
function writeFile(filepath, content) {
  ...
  console.log('✓', filepath.replace(BASE_DIR, 'src'));
}

// Create directories
console.log('\n📁 Creating directory structure...\n');
['components', 'pages/public', 'pages/admin', 'pages/branch', 'pages/staff', 'pages/member', 'hooks', 'services', 'context', 'utils'].forEach(dir => {
...
// Input component
writeFile(path.join(BASE_DIR, 'components/Input.jsx'), `import React from 'react';
...
// Badge component
writeFile(path.join(BASE_DIR, 'components/Badge.jsx'), `import React from 'react';
...
// DataTable component
writeFile(path.join(BASE_DIR, 'components/DataTable.jsx'), `import React, { useState } from 'react';
...
writeFile(path.join(BASE_DIR, 'components/PageWrapper.jsx'), `import React from 'react';
...
// StatCard component
writeFile(path.join(BASE_DIR, 'components/StatCard.jsx'), `import React from 'react';
...
writeFile(path.join(BASE_DIR, 'components/ProtectedRoute.jsx'), `import React from 'react';
...
const existingButton = fs.readFileSync(path.join(BASE_DIR, 'Button.jsx'), 'utf8');
writeFile(path.join(BASE_DIR, 'components/Button.jsx'), existingButton);

// Create components index
writeFile(path.join(BASE_DIR, 'components/index.js'), `export { Button } from './Button';
...
const pages = [
  ['pages/public/LoginPage.jsx', 'LoginPage', 'Login'],
  ['pages/public/RegisterPage.jsx', 'RegisterPage', 'Register'],
  ['pages/public/UnauthorizedPage.jsx', 'UnauthorizedPage', 'Unauthorized'],
  ['pages/admin/AdminDashboard.jsx', 'AdminDashboard', 'Admin Dashboard'],
  ['pages/admin/MembersPage.jsx', 'MembersPage', 'Members'],
  ['pages/admin/BranchesPage.jsx', 'BranchesPage', 'Branches'],
  ['pages/admin/StaffPage.jsx', 'StaffPage', 'Staff'],
  ['pages/admin/PaymentsPage.jsx', 'PaymentsPage', 'Payments'],
  ['pages/admin/AnalyticsPage.jsx', 'AnalyticsPage', 'Analytics'],
  ['pages/branch/BranchDashboard.jsx', 'BranchDashboard', 'Branch Dashboard'],
  ['pages/branch/ClassesPage.jsx', 'ClassesPage', 'Classes'],
  ['pages/branch/AttendancePage.jsx', 'AttendancePage', 'Attendance'],
  ['pages/branch/EquipmentPage.jsx', 'EquipmentPage', 'Equipment'],
  ['pages/staff/StaffDashboard.jsx', 'StaffDashboard', 'Staff Dashboard'],
  ['pages/staff/CheckinPage.jsx', 'CheckinPage', 'Check-in'],
  ['pages/staff/TrainingPage.jsx', 'TrainingPage', 'Training'],
  ['pages/member/MemberDashboard.jsx', 'MemberDashboard', 'Member Dashboard'],
  ['pages/member/BookingsPage.jsx', 'BookingsPage', 'Bookings'],
  ['pages/member/SessionsPage.jsx', 'SessionsPage', 'Sessions'],
  ['pages/member/PaymentsPage.jsx', 'MemberPaymentsPage', 'Payments'],
];

pages.forEach(([filepath, funcName, title]) => {
  const isMemberPayments = funcName === 'MemberPaymentsPage';
  writeFile(path.join(BASE_DIR, filepath), `import React from 'react';
...
writeFile(path.join(BASE_DIR, 'services/member.service.js'), `import axios from 'axios';
...
// Copy AuthContext to context folder
console.log('\n📝 Creating context files...\n');

const authContext = fs.readFileSync(path.join(BASE_DIR, 'AuthContext.jsx'), 'utf8');
writeFile(path.join(BASE_DIR, 'context/AuthContext.jsx'), authContext);

// Create App.jsx
console.log('\n📝 Creating App.jsx...\n');

writeFile(path.join(BASE_DIR, 'App.jsx'), `import React from 'react';
...
console.log('   src/');
console.log('   ├── components/    (7 reusable components + index.js)');
console.log('   ├── pages/         (public, admin, branch, staff, member - 20 pages total)');
console.log('   ├── services/      (member.service.js)');
console.log('   ├── context/       (AuthContext.jsx)');
console.log('   ├── hooks/         (ready for custom hooks)');
console.log('   ├── utils/         (ready for utilities)');
console.log('   └── App.jsx        (main app with routing)');
