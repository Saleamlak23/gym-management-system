...
export const MembersModule: React.FC = () => {
  ...
  const plansData: MembershipPlan[] = [
    ...
    },
    {
      ...
      duration: 30,
      price: 4000,
      features: ['24/7 gym access', 'Classes included', 'Personal trainer (1 session)', 'Premium locker']
    },
    {
      id: 3,
      name: 'Annual Plan',
      ...
      duration: 365,
      price: 35000,
      features: ['24/7 gym access', 'Unlimited classes', '4 free trainer sessions', 'Nutrition consultation']
    }
  ];
